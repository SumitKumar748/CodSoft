    ...
    public static void main(String[] args) {
        ...
        //{
            ...
            if (input == 1) {
                ...
                System.out.println(output + " USD= " + output1 + " INR");
            } else if (input == 2) {
                output1 = output * 0.94;
                System.out.println(output + " USD= " + output1 + " EUR");
            } else if (input == 3) {
                output1 = output * 147.63;
                System.out.println(output + " USD= " + output1 + " JPY");
            } else if (input == 4) {
                output1 = output * 88.85;
                System.out.println(output + " EUR= " + output1 + " INR");
            } else if (input == 5) {
                output1 = output * 1.07;
                System.out.println(output + " EUR= " + output1 + " USD");
            } else if (input == 6) {
                output1 = output * 157.48;
                System.out.println(output + " EUR= " + output1 + " JPY");
            } else if (input == 7) {
                output1 = output * 0.012;
                System.out.println(output + " INR= " + output1 + " USD");
            } else if (input == 8) {
                output1 = output * 0.011;
                System.out.println(output + " INR= " + output1 + " EUR");
            } else if (input == 9) {
                output1 = output * 1.77;
                System.out.println(output + " INR= " + output1 + " JPY");
            } else {
